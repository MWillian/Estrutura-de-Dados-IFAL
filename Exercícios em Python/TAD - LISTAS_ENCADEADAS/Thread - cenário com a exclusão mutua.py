...
Thread1 = threading.Thread(target=inserirXVezes,args=(ListaExemplo, 2,"1"))
Thread2 = threading.Thread(target=inserirXVezes,args=(ListaExemplo, 2,"2"))
Thread3 = threading.Thread(target=removerXVezes,args=(ListaExemplo, 4,"3"))
Thread4 = threading.Thread(target=removerXVezes,args=(ListaExemplo, 4,"4"))
